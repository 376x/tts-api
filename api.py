...
parser.add_argument("-dr", "--default_refer_path", type=str, default="raw/周婧参考.wav", help="默认参考音频路径")
parser.add_argument("-dt", "--default_refer_text", type=str, default="结婚、事业成功，成为人生赢家。这些对他们来说", help="默认参考音频文本")
...
config.write(open('./tts_api/config.ini', 'w'))
